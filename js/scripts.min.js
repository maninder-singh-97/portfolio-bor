...
!function(n){n(document).ready(function(){var e=new Date("2021-07-01"),t=new Date(t.getFullYear(),t.getMonth()+1,0),a=t.getFullYear()-e.getFullYear(),r=t.getMonth()-e.getMonth();r<0&&(a--,r+=12);var i=a+" year"+(a!==1?"s":"")+" and "+r+" month"+(r!==1?"s":"");n("#experience-years").text(i)})}(jQuery);
