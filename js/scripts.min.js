...
!function(n){n(document).ready(function(){var e=new Date("2021-07-01"),t=new Date,a=t.getFullYear()-e.getFullYear(),r=t.getMonth()-e.getMonth();r<0||0===r&&t.getDate()<e.getDate()?(a--,r+=12):0;var i=r>=6?`${a}+ years`:`${a} years`;n("#experience-years").text(i)})}(jQuery);
