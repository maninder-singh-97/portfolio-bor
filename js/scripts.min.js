...
!function(n){
  n(document).ready(function(){
    ...
    var years = endOfMonth.getFullYear() - startDate.getFullYear();
    var months = endOfMonth.getMonth() - startDate.getMonth();
    ...
    let result = "";
    if (years > 0 && months > 0) {
      result = years + " year" + (years !== 1 ? "s" : "") + " and " +
               months + " month" + (months !== 1 ? "s" : "") + " of";
    } else if (years > 0) {
      result = years + " year" + (years !== 1 ? "s" : "") + " of";
    } else if (months > 0) {
      result = months + " month" + (months !== 1 ? "s" : "") + " of";
    }

    n("#experience-years").text(result);
  });
}(jQuery);
